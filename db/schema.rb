...
ActiveRecord::Schema.define(version: 2020_10_18_201850) do
  ...
  create_table "recipe_ingredients", force: :cascade do |t|
    ...
    t.bigint "measurement_quantity_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["ingredient_id"], name: "index_recipe_ingredients_on_ingredient_id"
    t.index ["measurement_quantity_id"], name: "index_recipe_ingredients_on_measurement_quantity_id"
  ...
  add_foreign_key "recipe_ingredients", "measurement_quantities"
